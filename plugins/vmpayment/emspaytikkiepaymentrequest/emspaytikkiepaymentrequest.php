...
class plgVmPaymentEmspaytikkiepaymentrequest extends EmspayVmPaymentPlugin
{
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        try {
            $response = $this->getGingerClient()->createOrder(array_filter([
                ...
                'transactions' => [
                    [
                        'payment_method' => 'tikkie-payment-request',       // Payment method
                    ]
                ],
    ...
    public function plgVmOnPaymentResponseReceived(&$html, &$payment_reponse)
    {
       ...
       /* if (!$gingerOrder instanceof GingerPayments\Payment\Order) {
        ...
        if ($statusSucceeded) {
            ...
            $payment_reponse.="<br>"."Paid with ".$this->getDataByOrderId($virtuemart_order_id)->payment_name;            vRequest::setVar('html', $html);
