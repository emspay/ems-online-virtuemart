...
class plgVmPaymentIngpspcashondelivery extends IngpspVmPaymentPlugin
{
    ...
    public function plgVmConfirmedOrder($cart, $order)
    {
        ...
        try {
            $response = $this->getGingerClient()->createCashOnDeliveryOrder(
                    $totalInCents,              // Amount in cents
                    $currency_code_3,           // Currency
                    $paymentMethodDetails,      // Issuer Id
